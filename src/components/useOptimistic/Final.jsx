...
const Thread = ({messages, sendMessage}) => {
    const [optimisticMessages, addOptimisticMessages] = useOptimistic(messages, (state, newMessage) => [...state, {
        text : newMessage,
        sending : true
    }]);
    return (
        <div>
            <MessageForm sendMessage={sendMessage} addOptimisticMessages={addOptimisticMessages} />
            {
